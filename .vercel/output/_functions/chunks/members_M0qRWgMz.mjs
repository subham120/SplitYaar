...
var $$Members = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		"title": `Manage Members — ${trip.name}`,
		"noindex": true
  ...
  ${maybeRenderHead($$result)}<div class="bg-canvas-parchment min-h-[90vh] pb-[60px] pt-lg px-lg"><div class="max-w-[1440px] w-full mx-auto grid grid-cols-1 lg:grid-cols-3 gap-lg"><!-- Left 2 Columns: Members List & UPI configuration --><div class="lg:col-span-2 space-y-md"><!-- Error Alert box --><div id="members-alert-box" class="hidden bg-red-50 border border-red-200 rounded-md p-md text-caption text-red-600 animate-fadeIn"></div><div class="bg-white border border-hairline rounded-lg p-lg shadow-sm"><h2 class="text-body-strong font-semibold text-ink mb-lg">Group Members</h2><div class="space-y-lg" id="members-list-container">${members.map((m) => {
    ...
    if (membersList) {
      membersList.addEventListener('click', async (e) => {
        ...
        if (target.classList.contains('remove-member-btn')) {
          ...
          const confirmDel = confirm(\`Are you sure you want to remove \${memberName} from this trip?\`);
...
}, "D:/project/SplitYaar/src/pages/trip/[code]/members.astro", void 0);
var $$file = "D:/project/SplitYaar/src/pages/trip/[code]/members.astro";
var $$url = "/trip/[code]/members";
//#endregion
//#region \0virtual:astro:page:src/pages/trip/[code]/members@_@astro
